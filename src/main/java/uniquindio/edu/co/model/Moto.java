...
public class Moto extends Vehiculo {
     ...
     */
    public Moto(String placa, String nombreConductor, String identificacionConductor) {
        super(placa, "MOTO", nombreConductor, identificacionConductor);
    }

    /**
     * Calcula el costo de parqueo para una moto.
     *
